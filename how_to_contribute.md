...
### Create a sulfate project (do this once)
...
2. Create a feature branch for your changes
	...
	- On your local machine, from inside the repo, with main up to date:
	```
			git checkout -b feature-xyz
	```
	- feature-xyz is any name you choose that describes the work (e.g., sulfate-figure-improvements)
...
3. Make changes locally and commit them
	...
	- On your local machine, edit files in RStudio / Sublime / etc:
	```
			git status                   # see what changed
			git add sulfate.Rmd          # add specific files
...
4. Push the new branch to GitHub
	...
	```
			...
			# the -u sets the “upstream” flag so later you can just do git push
	```
	- After this, your branch exists both locally as feature-xyz and on GitHub as origin/feature-xyz
...
6. Open a Pull Request and merge into main (maintainer does this on GitHub)
	...
	- You may see a banner: “Compare & pull request” for feature-xyz, click it
	- Or manually: 
	...
	- After this, on GitHub, main now includes all changes from feature-xyz.
...
8. (Optional but tidy) Delete the feature branch
	...
	- On GitHub, on the PR page, click “Delete branch”
	- On your local machine:
	```
